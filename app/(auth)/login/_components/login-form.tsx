...
import { Checkbox } from "@/components/ui/checkbox"; // Keeping import if needed later
import {
  Card,
  CardContent,
  CardHeader,
    ...
    <Card className="w-full max-w-[420px] border-none shadow-none bg-transparent relative z-10">
      ...
      <CardContent className="px-0">
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          ...
          <Button type="submit" className="w-full h-11 rounded-lg text-base font-medium shadow-md hover:shadow-lg transition-all" disabled={isLoading}>
            {isLoading ? (
      ...
      <CardFooter className="px-0 flex flex-col gap-4">
        ...
        {/* Social Login Placeholders (can be functional later) */}
        <div className="grid grid-cols-2 gap-3 w-full">
          <Button variant="outline" className="w-full h-10 rounded-lg">
            <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
              ...
              <path d="M5.84 14.17c-.22-.66-.35-1.36-.35-2.17s.13-1.51.35-2.17V7.66H2.18C1.43 9.17 1 10.86 1 12.63s.43 3.46 1.18 4.97l3.66-2.86.35-.57z" fill="#FBBC05" />
