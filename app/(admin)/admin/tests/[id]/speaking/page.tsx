...
import {
  ...
  Part2Data,
  Part3Data,
} from "../../add/_components/SpeakingPartCard";
...
function EditSpeakingFormInner({ params }: { params: { id: string } }) {
...
export default function EditSpeakingTestPage({ params }: { params: { id: string } }) {
  return (
    <Suspense fallback={<div className="p-8 text-slate-500">Loading…</div>}>
      <EditSpeakingFormInner params={params} />
    </Suspense>
  );
}
