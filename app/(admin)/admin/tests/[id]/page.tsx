        ...
        <div className="p-6 md:p-10 max-w-5xl mx-auto flex flex-col gap-8">
            ...
            {(test.writingTasks ?? []).length > 0 && (
                <div className="rounded-xl border bg-card overflow-hidden">
                    <div className="bg-muted/50 px-5 py-3 font-semibold text-sm">Writing Tasks</div>
                    <div className="divide-y">
            ...
            {(test.speakingParts ?? []).length > 0 && (
                <div className="rounded-xl border bg-card overflow-hidden">
                    <div className="bg-muted/50 px-5 py-3 font-semibold text-sm">Speaking Parts</div>
                    <div className="divide-y">
