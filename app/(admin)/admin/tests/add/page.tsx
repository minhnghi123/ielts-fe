      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          {testData.sections.map((section, sIndex) => (
            <div
              key={sIndex}
              className="bg-white border rounded-xl shadow-sm outline outline-1 outline-slate-200 overflow-hidden"
            >
                ...
                {testData.skill === "reading" && (
                  <div>
                    ...
                    <RichTextEditor
                      ...
                      onChange={(val: any) =>
                        updateSection(sIndex, "passage", val)
                      }
                    />
                  </div>
                )}
                ...
                <div className="mt-8">
                  ...
                  <div className="space-y-6">
                    {section.groups.map((group, gIndex) => (
                      <div
                        key={gIndex}
                        className="p-4 border border-slate-200 rounded-lg bg-slate-50 relative group/g"
                      >
                        <button
                        ...
                        <div className="mb-6">
                          ...
                          <RichTextEditor
                            ...
                            onChange={(val: any) =>
                              updateGroup(sIndex, gIndex, "instructions", val)
                            }
                          />
                        </div>
                        ...
                        <div className="space-y-6 pl-4 border-l-2 border-slate-200">
                          {group.questions.map((q, qIndex) => {
                            const commonProps = {
                              ...
                              onUpdateAnswer: (field: string, value: any) =>
                                updateAnswer(
                                  sIndex,
                                  gIndex,
                                  qIndex,
                              ...
                              onRemove: () =>
                                removeQuestion(sIndex, gIndex, qIndex),
                            };
